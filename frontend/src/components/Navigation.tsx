...
const tabs = [
  { name: "Idea Constellation", shortName: "Ideas", path: "/" },
  { name: "Search", shortName: "Search", path: "/search" },
  { name: "How it Works", shortName: "How", path: "/how-it-works" },
];
...
export default function Navigation() {
  ...
  return (
    <>
      {/* Desktop Navigation */}
      <div className="fixed top-4 left-4 z-50 hidden md:flex items-center gap-3">
        {/* Logo */}
        <Link
          href="/"
